# Controlled test plan for `0.1.0-alpha.2`
...
2. Select prerelease `0.1.0-alpha.2`, download it, and restart Home Assistant.
3. Confirm that **Entity Memory** appears with its icon under **Add integration**.
